<%@ Page Title="" Language="C#" MasterPageFile="~/_supervisor/master_page.master" AutoEventWireup="true" CodeFile="delete_useless_loggers.aspx.cs" Inherits="_supervisor_device_delete_useless_loggers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="main-content2">
        <div id="main-content-title">
            <h2 class="title">Xóa logger không sử dụng</h2>
        </div>
       <div class="container-fluid m-t">
            ...
            <telerik:RadGrid ID="grv" runat="server" AutoGenerateColumns="False" AllowMultiRowSelection="True"
                CellSpacing="0" GridLines="None" DataSourceID="LoggersDataSource"
                AllowPaging="True" PageSize="20" Width="100%">
                <ClientSettings>
                    <Selecting CellSelectionMode="None" AllowRowSelect="true"></Selecting>
                </ClientSettings>

                <MasterTableView DataSourceID="LoggersDataSource">
            ...
            <telerik:RadWindow ID="winConfirmDelete" runat="server" Modal="True"
                ...
                <ContentTemplate>
                    <table style="width: 100%; text-align: center" cellpadding="5">
                        <tr>
                            <td>Bạn có muốn xóa logger không?
                            </td>
                        </tr>
                        <tr>
                            <td>
