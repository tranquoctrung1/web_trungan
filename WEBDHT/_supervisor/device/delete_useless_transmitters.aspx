<%@ Page Title="" Language="C#" MasterPageFile="~/_supervisor/master_page.master" AutoEventWireup="true" CodeFile="delete_useless_transmitters.aspx.cs" Inherits="_supervisor_device_delete_useless_transmitters" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="main-content">
        <div id="main-content-title">
            <h2 class="title">Xóa bộ hiển thị không sử dụng</h2>
        </div>
        <div class="container-fluid m-t">
            ...
            <telerik:RadGrid ID="grv" runat="server" AutoGenerateColumns="False" AllowMultiRowSelection="True"
                CellSpacing="0" GridLines="None" DataSourceID="TransmittersDataSource"
                AllowPaging="True" PageSize="20" Width="100%">
                <ClientSettings>
                    <Selecting CellSelectionMode="None" AllowRowSelect="true"></Selecting>
                </ClientSettings>

                <MasterTableView DataSourceID="TransmittersDataSource">
            ...
            <telerik:RadWindow ID="winConfirmDelete" runat="server" Modal="True"
                ...
                <ContentTemplate>
                    <table style="width: 100%; text-align: center" cellpadding="5">
                        <tr>
                            <td>Bạn có muốn xóa bộ hiển thị không?
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Button ID="btnConfim" runat="server" Text="Xóa" CssClass="btn btn-danger"
                                    OnClick="btnConfirmDelete_Click"></asp:Button>
