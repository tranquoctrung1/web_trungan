<%@ Page Title="" Language="C#" MasterPageFile="~/_supervisor/master_page.master" AutoEventWireup="true" CodeFile="transmitter.aspx.cs" Inherits="_supervisor_device_transmitter" %>
        ...
        <div class="container-fluid m-t">
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="group-text">
                        <div class="row">
                            <span>Seri đồng hồ</span>
                        </div>
                        <div class="row m-b">
                            <telerik:RadComboBox runat="server" ID="cboMeterSerials" AllowCustomText="True"
                                DataSourceID="MetersDataSource" DataTextField="Serial" DataValueField="Serial"
                                EnableLoadOnDemand="True" Filter="StartsWith"
                                HighlightTemplatedItems="True" TabIndex="18">
                            </telerik:RadComboBox>
