...
public partial class _supervisor_report_rou_company : BasePage
{
    ...
    protected void btnOutput_Click(object sender, EventArgs e)
    {
        ...
        List<ReportDailyData> list = _reportOutputsBLL.GetDailyOutputByCompany(cboCompanies.Text, start, end);
        ...
        rpt.LocalReport.DisplayName = "_san_luong_diem_lap_dat_" + company + "_quan_ly_ky_" + end.Month.ToString() + "_" + end.Year.ToString();
