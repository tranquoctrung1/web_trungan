<%@ Page Language="C#" MasterPageFile="~/_supervisor/master_page.master" AutoEventWireup="true" CodeFile="statisticLogger.aspx.cs" Inherits="_supervisor_report_statisticLogger" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        function getData() {
            ...
            let url = `${hostname}/api/getstatisticdevicelogger`;
            console.log(url)
            ...
            axios.get(url).then((res) => {
                ...
                talbe = $('#example').DataTable({
                    ...
                    buttons: [
                        {
                            extend: 'excelHtml5',
                            title: 'Thong_Ke_Logger_Theo_Tinh_Trang'
                        },
                        {
                            extend: 'csvHtml5',
                            title: 'Thong_Ke_Logger_Theo_Tinh_Trang'
