...
public partial class _supervisor_report_rou_group4 : BasePage
{
    ...
    protected void btnOutput_Click(object sender, EventArgs e)
    {
        ...
        List<ReportDailyData> list = _reportOutputsBLL.GetDailyOutputByGroup4(cboGroups.Text, start, end);
