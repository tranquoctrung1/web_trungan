<%@ Page Language="C#" MasterPageFile="~/_supervisor/master_page.master" AutoEventWireup="true" CodeFile="statisitcAccreditationMeter.aspx.cs" Inherits="_supervisor_report_statisitcAccreditationMeter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="main-content2">
        <div id="main-content-title">
            <h2 class="title">Thống Kê Kiểm Định Đồng Hồ</h2>
        </div>
        ...
        function createBodyForAccredited(data) {
            ...
            $('#example').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Thong_Ke_Kiem_Dinh_Dong_Ho'
                    },
                    {
                        extend: 'csvHtml5',
                        title: 'Thong_Ke_Kiem_Dinh_Dong_Ho'
