...
public partial class _supervisor_report_rou_group2 : BasePage
{
    ...
    protected void btnOutput_Click(object sender, EventArgs e)
    {
        ...
        List<ReportDailyData> list = _reportOutputsBLL.GetDailyOutputByGroup2(cboGroups.Text, start, end);
