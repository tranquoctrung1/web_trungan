<%@ Page Language="C#"  MasterPageFile="~/_supervisor/master_page.master"  AutoEventWireup="true" CodeFile="statisticBatteryChanged.aspx.cs" Inherits="_supervisor_report_statisticBatteryChanged" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="main-content2">
        <div id="main-content-title">
            <h2 class="title">Thống Kê Thay Pin Bộ Hiển Thị</h2>
        </div>
    ...
    <script>
        function btnView_Click() {
            ...
            if (start == null || start == undefined || start.get_selectedDate() == null || start.get_selectedDate() == undefined) {
                ...
                let urlGetDataHasChanged = `${hostname}/api/getdatahaschanged/?eventToCreate=${5}&start=${totalSecondStart}`;
        ...
        function createBodyForBatteryChanged(data) {
            ...
            createFooterForBatteryChanged(data);
            ...
            $('#example').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Thong_Ke_Thay_Pin_Bo_Hien_Thi'
                    },
                    {
                        extend: 'csvHtml5',
                        title: 'Thong_Ke_Thay_Pin_Bo_Hien_Thi'
