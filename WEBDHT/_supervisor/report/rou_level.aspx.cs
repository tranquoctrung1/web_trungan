...
public partial class _supervisor_report_rou_level : BasePage
{
    ...
    private string _msgEmptyCompany = "Chưa nhập cấp đồng hồ.";
    ...
    {
        if (string.IsNullOrEmpty(cboLevels.Text))
        {
        ...
        string company = cboLevels.SelectedValue;
        List<ReportDailyData> list = _reportOutputsBLL.GetDailyOutputByLevel(cboLevels.Text, start, end);
        ...
        rpt.LocalReport.DisplayName = "_san_luong_diem_lap_dat_cap_" + company + "_ky_" + end.Month.ToString() + "_" + end.Year.ToString();
