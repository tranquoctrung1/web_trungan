<%@ Page Language="C#" MasterPageFile="~/_supervisor/master_page.master" AutoEventWireup="true" CodeFile="statisticLoggerChanged.aspx.cs" Inherits="_supervisor_report_statisticLoggerChanged" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="main-content2">
        <div id="main-content-title">
            <h2 class="title">Thống Kê Thay Logger</h2>
        </div>
    ...
    <script>
        function btnView_Click() {
            ...
            if (start == null || start == undefined || start.get_selectedDate() == null || start.get_selectedDate() == undefined) {
                ...
                let urlGetDataHasChanged = `${hostname}/api/getdatahaschanged/?eventToCreate=${3}&start=${totalSecondStart}`;
