<%@ Page Title="" Language="C#" MasterPageFile="~/_supervisor/master_page.master" AutoEventWireup="true" CodeFile="rou_level.aspx.cs" Inherits="_supervisor_report_rou_level" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="main-content-title">
            <h2>Sản lượng theo cấp đồng hồ</h2>
            <hr class="line" />
        </div>
                ...
                <tr>
                    ...
                    <td>
                            <telerik:RadComboBox ID="cboLevels" Runat="server" AllowCustomText="True" 
                                ...
                                DataTextField="Level" DataValueField="Level">
                                <HeaderTemplate>
