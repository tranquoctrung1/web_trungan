<%@ Page Title="" Language="C#" MasterPageFile="~/_supervisor/master_page.master" AutoEventWireup="true" CodeFile="change_logger.aspx.cs" Inherits="_supervisor_site_change_logger" %>
                    ...
                    <div class="group-text">
                        ...
                        <div class="row m-b">
                            <telerik:RadComboBox ID="cboOldSerials" Runat="server" 
                                DataSourceID="LoggersDataSource" DataTextField="Serial" 
                                DataValueField="Serial" AllowCustomText="True" DropDownWidth="300px" 
                    ...
                    <div class="group-text">
                        ...
                        <div class="row m-b">
                            <telerik:RadComboBox ID="cboNewSerials" Runat="server" 
                                DataSourceID="LoggersDataSource1" DataTextField="Serial" 
                                DataValueField="Serial" AllowCustomText="True" DropDownWidth="300px" 
                                EnableLoadOnDemand="True" Filter="StartsWith" HighlightTemplatedItems="True">
                                <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0">
                            ...
                            <asp:ObjectDataSource ID="LoggersDataSource1" runat="server" 
                                OldValuesParameterFormatString="original_{0}" SelectMethod="GetAllByInstalled" 
                                TypeName="LoggersBLL">
                                <SelectParameters>
    ...
    <telerik:RadWindow ID="winConfirmDelete" runat="server" Modal="True"
        ...
        <ContentTemplate>
            <table width="100%" style="text-align: center">
                <tr>
                    <td>Bạn có muốn xóa dữ liệu thay logger tại ngày đã chọn? Thao tác xóa không có tác dụng xóa hiện trạng logger, ngày thay logger của điểm lắp đặt cũng như trạng thái lắp đặt của 2 logger.
                    </td>
                </tr>
                <tr>
                    <td>&nbsp</td>
