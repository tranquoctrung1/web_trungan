<%@ Page Title="" Language="C#" MasterPageFile="~/_supervisor/master_page.master" AutoEventWireup="true" CodeFile="change_meter.aspx.cs" Inherits="_supervisor_site_change_meter" %>
...
//]]>
    ...
    <div id="main-content2">
        <div id="main-content-title">
            <h2 class="title">Thay đồng hồ</h2>
        </div>
                    ...
                    <div class="group-text">
                        ...
                        <div class="row m-b">
                            <telerik:RadComboBox ID="cboOldSerials" Runat="server" 
                                DataSourceID="MetersDataSource" DataTextField="Serial" 
                    ...
                    <div class="group-text">
                        ...
                        <div class="row m-b">
                            <telerik:RadComboBox ID="cboNewSerials" Runat="server" 
                                DataSourceID="MetersDataSource1" DataTextField="Serial" 
                                DataValueField="Serial" AllowCustomText="True" EnableLoadOnDemand="True" 
                                Filter="StartsWith" HighlightTemplatedItems="True" DropDownWidth="300px">
                                <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0">
                            ...
                            <asp:ObjectDataSource ID="MetersDataSource1" runat="server" 
                                OldValuesParameterFormatString="original_{0}" SelectMethod="GetAllByInstalled" 
                                TypeName="MetersBLL">
                                <SelectParameters>
    ...
    <telerik:RadWindow ID="winConfirmDelete" runat="server" Modal="True"
        ...
        <ContentTemplate>
            <table width="100%" style="text-align: center">
                <tr>
                    <td>Bạn có muốn xóa dữ liệu thay đồng hồ tại ngày đã chọn? Thao tác xóa không có tác dụng xóa hiện trạng đồng hồ, ngày thay đồng hồ của điểm lắp đặt cũng như trạng thái lắp đặt của 2 đồng hồ.
                    </td>
                </tr>
                <tr>
                    <td>&nbsp</td>
