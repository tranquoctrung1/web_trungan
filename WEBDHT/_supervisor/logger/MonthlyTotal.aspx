<%@ Page Language="C#" MasterPageFile="~/_supervisor/master_page.master" AutoEventWireup="true" CodeFile="MonthlyTotal.aspx.cs" Inherits="_supervisor_logger_MonthlyTotal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        function getData(start, end) {
            ...
            let urlGetDataDailySite = `${hostname}/api/getdatareportmonthlytotal/?start=${totalSecondStart}&end=${totalSecondEnd}`;
