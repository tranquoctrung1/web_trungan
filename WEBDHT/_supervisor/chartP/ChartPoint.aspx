...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="main-content2">
        <div id="main-content-title">
            <h2 class="title">Đồ Thị Theo Point</h2>
        </div>
    ...
    <script>
        ...
        function callAPIAndDrawChart(siteid, end, start) {
            ...
            let urlGetDataChart = `${hostname}/api/getdatachart/${siteid}/${totalSecondStart}/${totalSecondEnd}`;
        ...
        function callAPITimeAndDrawChart(siteid, end, start) {
            ...
            axios.get(urlGetTime).then((res) => {
                ...
                if (res.data != null && res.data != undefined && res.data.trim() != "") {
                    ...
                    let startDate = new Date(date.getFullYear(), date.getMonth(), date.getDate() - 1, date.getHours(), date.getMinutes(), date.getSeconds());
