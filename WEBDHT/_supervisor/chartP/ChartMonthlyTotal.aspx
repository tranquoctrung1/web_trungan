<%@ Page Language="C#" MasterPageFile="~/_supervisor/master_page.master" AutoEventWireup="true" CodeFile="ChartMonthlyTotal.aspx.cs" Inherits="_supervisor_chartP_ChartMonthlyTotal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="main-content2">
        <div id="main-content-title">
            <h2 class="title">Đồ Thị Tháng Tổng</h2>
        </div>
    ...
    <script>
        ...
        function callAPIAndDrawChart( end, start) {
            ...
            let urlGetDataChart = `${hostname}/api/getdatareportmonthlytotal/?start=${totalSecondStart}&end=${totalSecondEnd}`;
