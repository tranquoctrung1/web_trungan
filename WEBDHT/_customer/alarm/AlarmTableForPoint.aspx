<%@ Page Language="C#"  MasterPageFile="~/_customer/master_page.master" AutoEventWireup="true" CodeFile="AlarmTableForPoint.aspx.cs" Inherits="_customer_alarm_AlarmTableForPoint" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        function getData() {
            ...
            let url = `${hostname}/api/getalarmforpointbyuid?uid=${localStorage.getItem("staff")}&start=${totalSecondStart}&end=${totalSecondEnd}`;
