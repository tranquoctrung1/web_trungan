<%@ Page Language="C#" AutoEventWireup="true" CodeFile="map.aspx.cs" Inherits="_customer_map" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <%--<asp:Timer ID="Timer1" runat="server" Enabled="true" Interval="300000" ontick="Timer1_Tick"  
        >
        </asp:Timer>--%>
        <telerik:RadSplitter ID="RadSplitter1" runat="server"  Width="100%" Height="100%">
            <telerik:RadPane ID="RadPane1" runat="server" Width="22px" Scrolling="None">
                <telerik:RadSlidingZone ID="RadSlidingZone1" runat="server" SlideDuration="0">
                    ...
                    <telerik:RadSlidingPane ID="RadSlidingPane2" runat="server" Title="Menu" Width="250px" >
                        ...
                        <asp:SiteMapDataSource ID="SiteMapDataSource" runat="server" SiteMapProvider="SiteMap2" 
            ...
            <telerik:RadPane ID="RadPane2" runat="server">
                <cc1:GMap ID="GMap1" runat="server" Key="AIzaSyCQ0Cx40GYoH4Kiqnen7TnuaLzpeavrWUk" Width="100%" Height="100%" EnableTheming="true" enableHookMouseWheelToZoom="true"/>
            </telerik:RadPane>
        </telerik:RadSplitter>
