<%@ Page Language="C#"  MasterPageFile="~/_customer/master_page.master" AutoEventWireup="true" CodeFile="datalogger.aspx.cs" Inherits="_customer_logger_datalogger" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        let urlGetDataComplex = `${hostname}/api/getcomplexdatabyuid?uid=` + localStorage.getItem("staff");
