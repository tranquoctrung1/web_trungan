<%@ Page Language="C#" MasterPageFile="~/_supervisores/master_page.master" AutoEventWireup="true" CodeFile="SettingAlarm.aspx.cs" Inherits="_supervisores_alarm_SettingAlarm" %>
                    ...
                    <div class="group-text">
                        ...
                        <div class="row m-b">
                            <telerik:RadComboBox ID="cboIds" runat="server" AllowCustomText="True"
                                EnableLoadOnDemand="True" Filter="StartsWith" DataTextField="Id" DataValueField="Id"
