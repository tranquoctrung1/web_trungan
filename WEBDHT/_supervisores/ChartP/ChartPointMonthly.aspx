<%@ Page Language="C#"  MasterPageFile="~/_supervisores/master_page.master" AutoEventWireup="true" CodeFile="ChartPointMonthly.aspx.cs" Inherits="_supervisores_ChartP_ChartPointMonthly" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="main-content2">
        <div id="main-content-title">
            <h2 class="title">Đồ Thị Tháng Theo Point</h2>
        </div>
    ...
    <script>
        ...
        function callAPIAndDrawChart(siteid, end, start) {
            ...
            let urlGetDataChart = `${hostname}/api/getdatareportmonthlysite/${siteid}/${totalSecondStart}/${totalSecondEnd}`;
        ...
        function callAPITimeAndDrawChart(siteid, end, start) {
            ...
            axios.get(urlGetTime).then((res) => {
                ...
                if (res.data != null && res.data != undefined && res.data.trim() != "") {
                    ...
                    let startDate = new Date(temp.setMonth(temp.getMonth() - 12));
