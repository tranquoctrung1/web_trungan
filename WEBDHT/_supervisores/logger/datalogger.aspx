<%@ Page Language="C#" MasterPageFile="~/_supervisores/master_page.master" AutoEventWireup="true" CodeFile="datalogger.aspx.cs" Inherits="_supervisores_logger_datalogger" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        let urlGetDataComplex = `${hostname}/api/getcomplexdatabyuid?uid=` + localStorage.getItem("supervisor");
