<%@ Page Language="C#" MasterPageFile="~/DMA/master_page.master" AutoEventWireup="true" CodeFile="statisticDMA.aspx.cs" Inherits="DMA_report_statisticDMA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        function getData() {
            ...
            let url = `${hostname}/api/getstatisticdmabyuid?uid=${localStorage.getItem("dma")}`;
            console.log(url)
