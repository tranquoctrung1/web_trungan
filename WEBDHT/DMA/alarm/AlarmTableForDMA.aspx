<%@ Page Language="C#" MasterPageFile="~/DMA/master_page.master" AutoEventWireup="true" CodeFile="AlarmTableForDMA.aspx.cs" Inherits="DMA_alarm_AlarmTableForDMA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="main-content2">
        <div id="main-content-title">
            <h2 class="title">Bảng Cảnh Báo Cho DMA</h2>
        </div>
                ...
                <div class="col-sm-12">
                    <div>
                        ...
                        <div class="col-sm-4 search-area m-b">
                            <input class="form-control me-2" type="text" placeholder="Mã DMA" id="txtSearch">
    ...
    <script>
        ...
        function getData() {
            ...
            let url = `${hostname}/api/getalarmfordmabyuid?uid=${localStorage.getItem("dma")}&start=${totalSecondStart}&end=${totalSecondEnd}`;
        ...
        function searchHandle() {
            ...
            filterData = data.filter((item) => item.Company.toLowerCase().indexOf(txtSearch.value.toLowerCase()) !== -1);
        ...
        //    let url = `${hostname}/api/getturnhistoryalarm?type=DMA`;
        ...
        //    let url = `${hostname}/api/updateturnhistoryalarm?ison=${btnTurnAlarm.dataset.turn}&type=DMA`;
