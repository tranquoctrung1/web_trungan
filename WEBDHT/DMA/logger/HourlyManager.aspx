<%@ Page Language="C#"  MasterPageFile="~/DMA/master_page.master" AutoEventWireup="true" CodeFile="HourlyManager.aspx.cs" Inherits="DMA_logger_HourlyManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        function btnExportOnClick(e) {
            ...
            let a = $("<a />", {
                href: url,
                download: `San_Luong_Gio_${siteIDCbo.get_text()}_Tu_${convertDate2(start.get_selectedDate())}_Den_${convertDate2(end.get_selectedDate())}.xls`
