<%@ Page Language="C#"  MasterPageFile="~/DMA/master_page.master"  AutoEventWireup="true" CodeFile="ChartManagerDaily.aspx.cs" Inherits="DMA_logger_ChartManagerDaily" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="main-content2">
        <div id="main-content-title">
            <h2 class="title">Đồ Thị Ngày Theo DMA</h2>
        </div>
    ...
    <script>
        ...
        function callAPIAndDrawChart(siteid, end, start) {
            ...
            let urlGetDataChart = `${hostname}/api/getdatareportdailymanager/?manager=${siteid}&start=${totalSecondStart}&end=${totalSecondEnd}`;
            ...
            axios.get(urlGetDataChart).then((res) => {
                if (checkExistsData(res.data)) {
                    ...
                    titleChart.innerHTML = `Đồ thị sản lượng ngày theo DMA ${siteid}`;
        ...
        function callAPITimeAndDrawChart(siteid, end, start) {
            ...
            let startDate = new Date(temp.setDate(temp.getDate() - 3));
